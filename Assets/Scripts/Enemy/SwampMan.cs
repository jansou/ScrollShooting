...
public class SwampMan: MonoBehaviour 
{
	Spaceship spaceship;
	EnemyCommon common;
    public int power = 1;
    ...
    IEnumerator Attack1()
    {
        ...
        while (true)
        {
            ...
            Instantiate(une, transform.position, Quaternion.identity);
    ...
    void AimRun()
    {
		if(pt){
			...
			enemy.MoveAim(transform.position,pt.position,speed);
		}
